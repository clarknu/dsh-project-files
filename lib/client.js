...
.dsh-pf-title { font-weight: 600; flex: 1; padding: 0 2px; }
...
.dsh-pf-body { flex: 1; min-height: 0; display: flex; }
.dsh-pf-tree { width: 46%; min-width: 0; overflow: auto; padding: 2px 0 8px; user-select: none;
  touch-action: pan-y; overscroll-behavior: contain; -webkit-overflow-scrolling: touch; }
.dsh-pf-preview { flex: 1; min-width: 0; overflow: auto; border-left: 1px solid var(--dsw-alias-border-l1, #e5e7eb);
  touch-action: pan-y; overscroll-behavior: contain; -webkit-overflow-scrolling: touch; }
...
.dsh-pf-pre { margin: 0; padding: 10px 12px; font-family: ui-monospace, SFMono-Regular, Consolas, monospace;
  ...
  user-select: text; -webkit-user-select: text; touch-action: pan-y; overscroll-behavior: contain; }
...
@media (max-width: 720px) {
  .dsh-pf { left: 0; width: 100vw; top: auto; height: 92vh; bottom: 0; border-left: none;
    border-top: 1px solid var(--dsw-alias-border-l1, #e5e7eb); }
  .dsh-pf-body { flex-direction: column; }
  .dsh-pf-tree { width: 100%; max-height: 45%; }
  .dsh-pf-preview { border-left: none; border-top: 1px solid var(--dsw-alias-border-l1, #e5e7eb); }
}
`
    ...
    function Panel(props) {
      ...
      var treeEl = h('div', { className: 'dsh-pf-tree' },
      ...
      return h('div', { className: 'dsh-pf' },
        ...
        crumbsEl,
        h('div', { className: 'dsh-pf-body' }, treeEl, previewEl))
    }
